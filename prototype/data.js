...
(function () {
  ...
  const COURSES = [
    { code: "CSC 301", title: "Data Structures & Algorithms", units: 3, type: "Core", lecturer: "Dr. E. Bassey", venue: "LH 1", desc: "Abstract data types, algorithm analysis (Big-O), trees, graphs, hashing, sorting and searching. Weekly lab in C++." },
    { code: "CSC 303", title: "Operating Systems", units: 3, type: "Core", lecturer: "Prof. K. Adewale", venue: "LH 2", desc: "Processes, threads, scheduling, memory management, file systems and concurrency, with Linux case studies." },
    { code: "CSC 305", title: "Database Management Systems", units: 3, type: "Core", lecturer: "Dr. F. Okonkwo", venue: "Lab 2", desc: "Relational model, ER design, normalisation, SQL, transactions and indexing. Project on a real schema." },
    { code: "CSC 307", title: "Computer Architecture", units: 2, type: "Core", lecturer: "Dr. M. Sani", venue: "LH 3", desc: "Digital logic, CPU datapath, pipelining, memory hierarchy and assembly-level programming." },
    { code: "CSC 309", title: "Object-Oriented Programming II", units: 3, type: "Core", lecturer: "Mr. T. Balogun", venue: "Lab 1", desc: "Advanced OOP in Java: generics, collections, exceptions, design patterns and unit testing." },
    { code: "CSC 311", title: "Web Application Development", units: 2, type: "Elective", lecturer: "Mrs. J. Eze", venue: "Lab 3", desc: "Full-stack fundamentals: HTML/CSS/JS, REST APIs, and a deployed semester project." },
    { code: "MTH 301", title: "Linear Algebra II", units: 3, type: "Core", lecturer: "Dr. P. Nwosu", venue: "LH 4", desc: "Vector spaces, linear transformations, eigenvalues, diagonalisation and applications." },
    { code: "GST 301", title: "Entrepreneurship Studies", units: 2, type: "GST", lecturer: "Dr. R. Lawal", venue: "Audit.", desc: "Opportunity identification, business modelling, finance basics and a venture pitch." },
    { code: "CSC 299", title: "Discrete Mathematics (Carryover)", units: 3, type: "Carryover", lecturer: "Dr. A. Ibrahim", carryover: true, venue: "LH 1", desc: "Logic, sets, relations, combinatorics and graph theory. Carried over from 200 level." },
    { code: "CSC 313", title: "Human–Computer Interaction", units: 2, type: "Elective", lecturer: "Dr. C. Madu", venue: "LH 2", desc: "Usability principles, interaction design, prototyping and user evaluation methods." },
  ];
  ...
  window.DATA = {
    STUDENT, FEES, CHARGES, PAYMENT_HISTORY, COURSES, HOSTELS, RESULTS, TIMETABLE, ANNOUNCEMENTS, NEWS, GPA_HISTORY, LECTURERS, VENUES, NOTIFICATIONS,
