...
(function () {
  ...
  const ENROLLED = { "CSC 305": ROSTERS["CSC 305"].length, "CSC 205": ROSTERS["CSC 205"].length, "CSC 411": ROSTERS["CSC 411"].length, "CSC 313": ROSTERS["CSC 313"].length, "CSC 303": ROSTERS["CSC 303"].length };
