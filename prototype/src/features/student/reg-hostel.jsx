...
const { Btn, Card, Empty, Icon, Modal, ModalHead, PageHead, Ref, Steps, Tag, printRegion } = window;
                  ...
                  <div className="u-grow">
                    ...
                    {plocked && (
                      <div className="u-meta" style={{ marginTop: 3, color: "var(--danger)" }}>
                        Pass {unmet.map((p) => window.DATA.courseName(p)).join(", ")} to unlock this course.
                      </div>
                    )}
                  </div>
