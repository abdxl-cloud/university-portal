...
const PORTAL_TILES = [
  { icon: "doc", t: "Apply for Admission", d: "Start or continue your application", to: "login" },
  ...
  { icon: "search", t: "Check Admission Status", d: "Track your application", to: "login" },
];
      ...
      <div className="u-hero">
        ...
        <div className="u-hero__inner">
          ...
          <div className="u-row u-wrap" style={{ gap: 10, marginTop: 28 }}>
            ...
            <Btn variant="secondary" size="lg" onClick={() => go("login")}>Apply for admission</Btn>
          </div>
        </div>
      </div>
...
function Login({ go, onLogin, dark, setDark }) {
  ...
  const staffIds = {
    ...
    librarian: "FUT/STF/LIB/0044", clinic: "FUT/STF/MED/0009",
      ...
      <div className="u-auth__panel">
        <div className="u-auth__card">
          ...
          <div className="u-meta" style={{ textAlign: "center" }}>
            {role === "student" ? <>New here? <a className="fb-link" onClick={() => go("home")}>Apply for admission</a></> : <>Need access? <a className="fb-link" onClick={() => go("home")}>Contact ICT support</a></>}
          </div>
        </div>
      </div>
