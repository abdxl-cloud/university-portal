      ...
      <div className="u-grid u-grid--3" style={{ marginBottom: 16 }}>
        ...
        <Card className="u-pad">
          <div className="u-stat">
            <div className="u-stat__k"><span className={"u-icon" + (store.feesPaid ? "" : " ")} style={{ width: 26, height: 26, background: store.feesPaid ? "var(--success-soft)" : "var(--danger-soft)", color: store.feesPaid ? "var(--success)" : "var(--danger)" }}><Icon name={store.feesPaid ? "check" : "info"} size={14} /></span>Outstanding</div>
